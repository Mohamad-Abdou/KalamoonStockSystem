<x-app-layout>
    <div class="flex flex-col items-center justify-center w-full gap-10">
                ...
                <form action="{{ route('admin.annual-requests.update-period') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex flex-col justify-center mt-4">
                        ...
                        <input type="date" id="request_end_date" name="request_end_date"
                            value="{{ old('request_end_date', $endDate->format('Y-m-d')) }}" required
                            min="{{ date('Y-m-d') }}" class="@error('request_end_date') border-red-500 @enderror">
        ...
        <div class="flex items-center justify-center w-full gap-10">
            @livewire('AnnualRequest\UpdateSemester')
        </div>
    </div>
</x-app-layout>
