<div class="flex justify-between gap-4 px-8 py-2.5 max-y-full">
    <section class="bg-white shadow-sm sm:rounded-lg basis-3/4 items-center">
        <div class="p-6 text-gray-900">
            <div wire:loading.class="opacity-50 bg-gray-300">
                <x-table.table>
                    <thead class="bg-gray-100 text-gray-700 text-center">
                        <tr>
                            ...
                            <x-table.table-header-element class="w-2">
                                الكمية المطلوبة
                            </x-table.table-header-element>
                            ...
                            <tr
                                ...
                                <x-table.data>
                                    <div class="w-full flex flex-row justify-center">
                                        <x-text-input
                                            wire:model.live.debounce.1000ms="objection.{{ $item->pivot->id }}" />
                                    </div>
                                </x-table.data>
                            </tr>
                        @endforeach
    ...
    <section class="basis-1/4" style="position: sticky; top: 1rem; height: fit-content" wire:loading.class="opacity-50 bg-gray-300">
