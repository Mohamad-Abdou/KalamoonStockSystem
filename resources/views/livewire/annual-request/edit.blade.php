                        ...
                        <tr
                            ...
                            <x-table.data>
                                <x-text-input class="w-full" type="number"
                                    wire:model.blur="selectedItems.{{ $id }}.first_semester_quantity"
                                    min="0" step="1" />
                            </x-table.data>
                            <x-table.data>
                                <x-text-input class="w-full" type="number"
                                    wire:model.blur="selectedItems.{{ $id }}.second_semester_quantity"
                                    min="0" step="1" />
                            </x-table.data>
                            <x-table.data>
                                <x-text-input class="w-full" type="number"
                                    wire:model.blur="selectedItems.{{ $id }}.third_semester_quantity"
                                    min="0" step="1" />
                            </x-table.data>
