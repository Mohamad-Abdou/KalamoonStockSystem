            ...
            <tbody>
                @foreach ($selectedItems as $id => $details)
                    <tr>
                        ...
                        <x-table.data >
                            <x-text-input type="number" wire:model.live.debounce="selectedItems.{{ $id }}.first_semester_quantity" class="w-full"/>
                        </x-table.data>
                        <x-table.data >
                            <x-text-input type="number" wire:model.live.debounce="selectedItems.{{ $id }}.second_semester_quantity" class="w-full"/>
                        </x-table.data>
                        <x-table.data >
                            <x-text-input type="number" wire:model.live.debounce="selectedItems.{{ $id }}.third_semester_quantity" class="w-full"/>
                        </x-table.data>
                        <x-table.data >
